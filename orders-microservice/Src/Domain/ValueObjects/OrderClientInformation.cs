...
namespace Order.Domain
{
    public class OrderClientInformation : IValueObject<OrderClientInformation>
    {
        ...
        public bool Equals(OrderClientInformation other) =>  _name == other._name && _image == other._image && _policyId == other._policyId && _phoneNumber == other._phoneNumber && _identificationNumber == other._identificationNumber;
    }
}